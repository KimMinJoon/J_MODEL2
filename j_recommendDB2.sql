...
-- 추천 게시판에 m_no 외래키 설정
ALTER TABLE j_recommend2 ADD CONSTRAINT fk_m_no_reco
FOREIGN KEY(m_no) REFERENCES j_member(m_no);


-- 추천 게시판에 brd_no 외래키 설정
ALTER TABLE j_recommend2 ADD CONSTRAINT fk_brd_no_reco
